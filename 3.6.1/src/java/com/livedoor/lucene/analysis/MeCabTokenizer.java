...
public class MeCabTokenizer extends Tokenizer
{
    ...
    public final boolean incrementToken() throws IOException
    {
        ...
        if (PayloadAs.POSID.equals(payloadAs))
        {
            ...
            payloadAtt.setPayload(new Payload(posIdBytes));
        }
        else if (PayloadAs.SURFACE.equals(payloadAs))
        {
            payloadAtt.setPayload(new Payload(node.getSurface().getBytes()));
        }
        else if (PayloadAs.FEATURE.equals(payloadAs))
        {
            payloadAtt.setPayload(new Payload(node.getFeature().getBytes()));
        }
        else if (PayloadAs.FORMATTED.equals(payloadAs))
        {
            payloadAtt.setPayload(new Payload(tagger.formatNode(node).getBytes()));
        }
