...
public class MeCabTokenizerFactory extends TokenizerFactory implements ResourceLoaderAware
{
    ...
    public void inform(ResourceLoader loader) throws IOException
    {
        ...
        if (stopPosidsFileStr != null)
        {
            ...
            {
                List<String> list = getLines(loader, stopPosidsFileStr);
            ...
            {
                List<String> stopPosidsFilesStr = splitFileNames(stopPosidsFileStr);
                for (String stopPosidsFileStr2 : stopPosidsFilesStr)
                {
                    List<String> list = getLines(loader, stopPosidsFileStr2.trim());
                    if (stopPosids == null)
                    {
                        stopPosids = new ArrayList<Integer>();
                    }
